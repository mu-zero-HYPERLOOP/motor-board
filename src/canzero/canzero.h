...
static const uint32_t canzero_message_motor_driver_stream_lim_temperature_id = 0x73;
typedef struct {
...
static const uint32_t canzero_message_motor_driver_stream_errors_id = 0x53;
typedef struct {
  uint8_t m_node_id;
